...
describe('Sell_Vanguard', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('Sell_Vanguard', async function() {
    vars["TICKER"] = "AREB"
    ...
    for (let i = 0; i < collection.length - 1; i++) {
      ...
      await driver.findElement(By.id("baseForm:transactionTypeSelectOne:2")).click()
      ...
      vars["costBasis"] = await driver.findElements(By.xpath("//*[@id=\"baseForm:costBasisMethodSelectOne_main\"]")).length
      if (!!await driver.executeScript("return (arguments[0] == 1)", vars["costBasis"])) {
        console.log("costBasisMethod exists")
      ...
      if (!!await driver.executeScript("return (arguments[0] == true)", vars["result"])) {
        ...
        console.log(vars["account"] finished selling)
      }
      await driver.sleep(1000)
      await driver.get("https://personal.vanguard.com/us/TradeTicket?investmentType=EQUITY")
    }
